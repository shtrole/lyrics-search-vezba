...
function ucitajPodatke(){
    ...
    .then(objekat => {
        naslovPesme.innerText = izvodjac + ' - ' + pesma;
        tekstPesme.innerText = objekat.lyrics ? objekat.lyrics : "Ne postoji tekst za trazenu pesmu. Pokusajte ponovo!" //kada imamo samo jedno izvrsavanje onda moze bez viticastih zagrada
